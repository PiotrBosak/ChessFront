...
tilesWithBlackBishops =
  let
    firstPosition = Position { file: C, rank: Eight }
  ...
  in
    ((insert firstPosition firstTile) >>> (insert secondPosition secondTile)) empty

tilesWithWhiteBishops :: Map Position Tile
tilesWithWhiteBishops =
  let
    firstPosition = Position { file: C, rank: One }
...
tilesWithWhiteKnights =
  let
    firstPosition = Position { file: B, rank: One }
...
tilesWithBlackKnights =
  let
    firstPosition = Position { file: B, rank: Eight }
...
tilesWithBlackRooks =
  let
    firstPosition = Position { file: A, rank: Eight }
...
tilesWithWhiteRooks =
  let
    firstPosition = Position { file: A, rank: One }
...
tileWithBlackQueen =
  let
    firstPosition = Position { file: D, rank: Eight }
...
tileWithWhiteQueen =
  let
    firstPosition = Position { file: D, rank: One }
...
createTilesInFile (Just file) rank piece =
  ...
  in
    insert position tile $ createTilesInFile (nextFile file) rank piece
